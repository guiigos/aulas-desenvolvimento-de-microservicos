...
const QUEUE = CONSUMER_QUEUES.STUDENT_CREATED;
  ...
  implements OnApplicationBootstrap, OnModuleDestroy
{
  ...
  async onApplicationBootstrap(): Promise<void> {
    ...
    this.logger.log(
      `Consumer registrado na fila "${QUEUE}" (routing key "${CONSUMER_ROUTING_KEYS.STUDENT_CREATED}")`,
    );
  }
...
function isStudentCreatedPayload(
  value: unknown,
